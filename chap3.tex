...
Operations Systems to better respond to an
event~\cite{meierDigitalHumanitariansHow2015}--- filtering out these actionable
tweets and thus better understanding the ground truth is at the core of much
research. 
...
shorter amount of time. Social media disaster data is mainly composed of images
or text, therefore researchers have focused on either image recognition or
Natural Language Processing (NLP) to classify data. More recently, there
have been some inroads to using ensemble methods that can utilize images and
text at the same time.

\subsection{Textual Analysis}\label{chap3:text}
...
\subsection{Image Recognition}\label{chap3:image}
